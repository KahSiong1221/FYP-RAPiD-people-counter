...
def export():
    ...
    input_size = 608  # input image will be resized to this size
    ...
    torch.onnx.export(model, dummy_input, "rapid608.onnx", verbose=False, opset_version=11)
...
def test_onnx():
    ...
    onnx_model = onnx.load("rapid608.onnx")
    onnx.checker.check_model(onnx_model)  # sanity check

    ort_session = onnxruntime.InferenceSession(
        "rapid608.onnx", providers=["CPUExecutionProvider"]
    )
